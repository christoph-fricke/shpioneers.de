...
if($_GET['index'] >= 0){
$desponsor = json_decode(file_get_contents('../../../content/sponsors/finance-de-de.json'))[$_GET['index']];
$ensponsor = json_decode(file_get_contents('../../../content/sponsors/finance-en-en.json'))[$_GET['index']];
}
else{
...
if($_GET['index'] >= 0){
$returnval -> submit = 'sponsors/finance/submit.php';
}
else{
$returnval -> submit = 'sponsors/finance/add.php';
}
