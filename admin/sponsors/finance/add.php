...
if(file_put_contents("../../../content/sponsors/finance-de-de.json", json_encode($desponsors))> 0 && file_put_contents("../../../content/sponsors/finance-en-en.json", json_encode($ensponsors)) > 0) echo 'suc';
else echo 'noc';
