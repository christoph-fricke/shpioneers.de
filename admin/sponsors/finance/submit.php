...
$desponsor = json_decode(file_get_contents("../../../content/sponsors/finance-de-de.json"));
$ensponsor = json_decode(file_get_contents("../../../content/sponsors/finance-en-en.json"));
...
file_put_contents("../../../content/sponsors/finance-de-de.json", json_encode($desponsor));
file_put_contents("../../../content/sponsors/finance-en-en.json", json_encode($ensponsor));
echo 'suc';
function checktoken(){
