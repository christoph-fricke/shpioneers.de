...
if($_GET['index'] >= 0){
$desponsor = json_decode(file_get_contents('../../../content/sponsors/partner-de-de.json'))[$_GET['index']];
$ensponsor = json_decode(file_get_contents('../../../content/sponsors/partner-en-en.json'))[$_GET['index']];
}
else{
...
if($_GET['index'] >= 0){
$returnval -> submit = 'sponsors/partner/submit.php';
}
else{
$returnval -> submit = 'sponsors/partner/add.php';
}
