...
if(file_put_contents("../../../content/sponsors/partner-de-de.json", json_encode($desponsors))> 0 && file_put_contents("../../../content/sponsors/partner-en-en.json", json_encode($ensponsors)) > 0) echo 'suc';
else echo 'noc';
